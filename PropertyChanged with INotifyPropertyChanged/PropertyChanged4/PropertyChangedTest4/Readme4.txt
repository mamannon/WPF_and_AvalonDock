The PropertyChangedTest4 is one solution using INotifyPropertyChanged interface with 
Avalon Dock. This is the elaborate one using 'DockingManager.LayoutItemTemplateSelector' 
property, which makes possible to sort wanted templates among other templates. 
